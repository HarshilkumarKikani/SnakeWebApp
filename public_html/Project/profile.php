...
$per_page = 10;
paginate("SELECT count(1) as points FROM Competitions WHERE modified > current_timestamp()");
...
<div>
    <h3>
        <p class="Balance"> Point Balance: <?php echo get_user_points(); ?> </p>
    </h3>
</div>
...
<div class="container-fluid">
    ...
    <?php if ($isMe) : ?>
        <?php if ($edit) : ?>
            <a class="btn btn-primary" href="?">Close Profile Settings</a>
        <?php else : ?>
            <a class="btn btn-primary" href="?edit=true">Edit Profile Settings</a>
        <?php endif; ?>
    <?php endif; ?>
    <div>
